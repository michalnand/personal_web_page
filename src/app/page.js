...
export default function HomePage() {
  // State to track which photo is currently active in the lightbox modal
  ...
  return (
    <div className="space-y-32">
      ...
      <section id="about" className="scroll-mt-24 grid md:grid-cols-5 gap-12 items-center">
        <div className="md:col-span-3 space-y-6">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight text-white leading-tight">
            Building <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#104E8B] to-blue-400">intelligent systems</span>, from algorithms to hardware.
          </h1>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <Link href="/projects/rl-exploration" className="group flex flex-col justify-between p-6 rounded-xl bg-[#16161A]/50 border border-[#1F2026] hover:border-[#104E8B]/60 transition-all duration-300">
            ...
            <div className="relative w-full h-full mt-2 rounded-lg bg-[#0F0F11] border border-[#1F2026] overflow-hidden opacity-80 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center p-1">
              <img src="/diagrams/montezuma.png" alt="Montezuma revenge" className="w-full h-full object-cover rounded" />
            </div>
          ...
          <Link href="/projects/line-follower" className="group flex flex-col justify-between p-6 rounded-xl bg-[#16161A]/50 border border-[#1F2026] hover:border-[#104E8B]/60 transition-all duration-300 relative overflow-hidden">
            ...
            <div className="relative w-full h-80 mt-2 rounded-lg bg-[#0F0F11] border border-[#1F2026] overflow-hidden opacity-80 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center p-1">
              <img src="/robotics/DSC05550.jpg" alt="Robot photo" className="w-full h-full object-cover rounded" />
            </div>
            <div className="mt-6 flex flex-wrap gap-2 pt-4 border-t border-[#1F2026]/50 text-xs font-mono text-gray-400">
          ...
          <Link href="/projects/vehicle-detection" className="group flex flex-col justify-between p-6 rounded-xl bg-[#16161A]/50 border border-[#1F2026] hover:border-[#104E8B]/60 transition-all duration-300 relative overflow-hidden">
            ...
            <div className="space-y-4">
              ...
              <div className="relative w-full h-24 mt-2 rounded-lg bg-[#0F0F11] border border-[#1F2026] overflow-hidden opacity-80 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center p-1">
                <img src="/vehicle_detector/wave_detail.png" alt="Magnetic flux waveform" className="w-full h-full object-cover rounded" />
              </div>
            </div>
            <div className="mt-6 flex flex-wrap gap-2 pt-4 border-t border-[#1F2026]/50 text-xs font-mono text-gray-400">
        ...
        <div className="space-y-6">
          <div className="p-6 rounded-xl bg-[#16161A]/30 border border-[#1F2026]/70 flex flex-col justify-between gap-4 hover:bg-[#16161A]/60 transition-colors">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 w-full">
              ...
              <a href="https://www.sciencedirect.com/science/article/abs/pii/S092523122400804X" target="_blank" rel="noopener noreferrer" className="shrink-0 inline-flex items-center justify-center px-4 py-2 text-xs font-mono font-semibold rounded-lg border border-[#104E8B]/40 text-blue-400 bg-[#104E8B]/5 hover:bg-[#104E8B] hover:text-white transition-all duration-200">
                ScienceDirect →
              </a>
            </div>
            <details className="group border-t border-[#1F2026]/50 pt-3 cursor-pointer">
              ...
              <p className="text-sm text-gray-400 leading-relaxed mt-3 bg-[#0F0F11]/40 p-4 rounded-lg border border-[#1F2026]/40 cursor-default">
                Reinforcement learning can solve decision-making problems...
              </p>
            </details>
          </div>
          ...
          <div className="p-6 rounded-xl bg-[#16161A]/30 border border-[#1F2026]/70 flex flex-col justify-between gap-4 hover:bg-[#16161A]/60 transition-colors">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 w-full">
              ...
              <a href="https://link.springer.com/chapter/10.1007/978-3-030-17935-9_26" target="_blank" rel="noopener noreferrer" className="shrink-0 inline-flex items-center justify-center px-4 py-2 text-xs font-mono font-semibold rounded-lg border border-purple-500/30 text-purple-400 bg-purple-500/5 hover:bg-purple-600 hover:text-white transition-all duration-200">
                SpringerLink →
              </a>
            </div>
            <details className="group border-t border-[#1F2026]/50 pt-3 cursor-pointer">
              ...
              <p className="text-sm text-gray-400 leading-relaxed mt-3 bg-[#0F0F11]/40 p-4 rounded-lg border border-[#1F2026]/40 cursor-default">
                Computer simulations of a blood flow...
              </p>
            </details>
          </div>
        </div>
      ...
      <section id="photography" className="scroll-mt-24 space-y-8">
        <div className="space-y-3">
          ...
          <div className="text-gray-400 space-y-2 max-w-3xl leading-relaxed">
            <p>A look through my lens—captured moments away from the terminal.</p>
            <p className="text-sm">
              Focusing primarily on the dramatic scale of <span className="text-white font-medium">Slovak mountain ranges</span> and <span className="text-white font-medium">Madeira</span>.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
          {photographyData.map((photo, idx) => (
            <div 
              ...
              className="aspect-video relative rounded-xl overflow-hidden bg-[#16161A] border border-[#1F2026] group cursor-pointer shadow-md"
            >
              <img 
        ...
        <div className="flex justify-center pt-4">
          <a href="https://eu.zonerama.com/Kenshin" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg font-mono text-xs font-semibold tracking-wide border border-[#104E8B]/60 bg-[#104E8B]/10 text-blue-400 hover:bg-[#104E8B] hover:text-white transition-all duration-200 shadow-sm group">
      ...
      {activePhoto && (
        ...
        >
          <div 
            className="relative max-w-5xl w-full max-h-[85vh] bg-[#16161A] border border-[#1F2026] rounded-2xl overflow-hidden shadow-2xl flex flex-col"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Close Button */}
            <button 
              onClick={() => setActivePhoto(null)}
              className="absolute top-4 right-4 z-10 w-8 h-8 flex items-center justify-center rounded-full bg-black/60 text-gray-400 hover:text-white border border-white/10 hover:border-white/20 transition-all font-mono text-sm"
            >
              ✕
            </button>

            {/* Expanded Image View */}
            <div className="relative flex-1 overflow-hidden bg-black flex items-center justify-center min-h-0">
              <img 
                src={`/photography/${activePhoto.slug}.jpg`} 
            ...
            {/* Footer Metadata */}
            <div className="p-4 bg-[#0F0F11] border-t border-[#1F2026] flex items-center justify-between text-left">
              <div>
                <h4 className="text-sm font-semibold text-white tracking-wide">{activePhoto.label}</h4>
                <p className="text-xs text-gray-400 font-mono mt-0.5">{activePhoto.dynamic}</p>
              </div>
              <span className="text-[10px] uppercase tracking-wider font-mono px-2 py-1 rounded border border-[#1F2026] text-gray-500 hidden sm:inline-block">
